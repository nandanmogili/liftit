...
type Profile = { id: string; username: string; avatar_path: string | null; avatar_position_x: number; avatar_position_y: number; avatar_zoom: number; weight_tracking_enabled?: boolean; preferred_weight_unit?: "lb" | "kg"; created_at: string; avatar_url?: string };
